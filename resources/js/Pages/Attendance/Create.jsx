...
export default function Create({ employees }) {
    ...
    const submit = (e) => { e.preventDefault(); post(route('attendance.store')); };

    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold text-gray-800">Log Attendance</h2>}>
