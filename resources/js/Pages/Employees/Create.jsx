...
export default function Create({ departments }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        email: '', phone: '', position: '', employment_type: 'full-time',
        basic_salary: '', hired_at: '', status: 'active',
    });

    const submit = (e) => { e.preventDefault(); post(route('employees.store')); };

    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold text-gray-800">New Employee</h2>}>
