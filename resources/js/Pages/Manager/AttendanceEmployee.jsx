...
function EditModal({ record, onClose }) {
    ...
    const submit = () => put(route('manager.attendance.logs.update', record.id), { onSuccess: onClose });
            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
                ...
                <div className="px-6 py-4 space-y-4 max-h-[65vh] overflow-y-auto">
                    ...
                    <div>
                        ...
                        {errors['logs.0.clock_in'] && (
                            <p className="mt-1 text-xs text-red-500">{errors['logs.0.clock_in']}</p>
                        )}
...
export default function AttendanceEmployee({ employee, records }) {
    ...
    return (
        <ManagerLayout header={
            <div className="flex items-center gap-3">
                <Link href={route('manager.attendance')} className="text-gray-400 hover:text-gray-600">
