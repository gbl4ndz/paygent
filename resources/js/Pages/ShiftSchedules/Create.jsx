...
export default function Create() {
    const { data, setData, post, processing, errors } = useForm({
        name: '', clock_in_time: '08:00', clock_out_time: '17:00',
        work_days: [1,2,3,4,5], is_default: false,
    });
    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold text-gray-800">New Shift Schedule</h2>}>
            <Head title="New Shift Schedule" />
            <div className="py-8 max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-white rounded-xl shadow p-6 space-y-5">
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        ...
                        <button onClick={() => post(route('shift-schedules.store'))} disabled={processing}
